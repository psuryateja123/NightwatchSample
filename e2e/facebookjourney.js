...
var facebookCredentials = require('../pom/facebookCredentials.js')
...
module.exports = {
    tags: ['facebook'],
    'opening the facebook login page': function (browser) {
        facebookCredentials(browser).fabookpagenavigation()
    },


    'entering facebook credentials': function (browser) {
        facebookCredentials(browser).facebooklogin()
    },

    'quote and buy from facebook login': function (browser) {
        facebookCredentials(browser).quoteandbuyfromfacebook()
    },
